...
export default function Footer() {
    return (
        <div className='mt-15'>
            <div className='bg-[#0D99FF] w-full md:w-70%'>
                <div className="flex justify-between lg:w-full md:w-[90%]">
                    ...
                    <div className='text-white flex  pt-15  flex-col'>
                        ...
                        <p className='text-[22px] text-center lg:p-0 md:p-0 sm:p-3 lg:pl-0 md:pl-0 sm:pl-6  p-3 lg:w-[110%] md:w-[110%] sm:w-[90%] '>Tell some words about your idea. <br /> We believe that every big deal starts with simple “Hello”</p>
                        ...
                        <div className='text-center lg:w-[110%] lg:pl-0 md:pl-0 pl-24 sm:pl-[45px] md:w-[110%] w-[470px] sm:w-[100%] pt-[28px]'>
            ...
            <div className=' lg:p-[18px] md:p-[18px] p-[28px] lg:pl-0 md:pl-0 sm:pl-10 pl-[100px]  bg-[#191919] lg:flex lg:justify-between md:flex md:justify-between md:gap-9'>
