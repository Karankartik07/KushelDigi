...
export default function Portfolio() {
    return (
        <div className='bg-[#24204E]  lg:mb-0 md:mb-0 sm:mb-[-20px] mb-[-90px]'>
            ...
            <img className='lg:hidden md:hidden h-40 w-56 ml-48 sm:block mb-[-70px]  ' src="/logos/lappy.png" alt="" />
            <div className=' flex w-100 lg:gap-0  h-[600px]'>
                ...
                <div className='lg:p-24 sm:p-10 sm:pl-10  lg:pl-33  relative'>
                    ...
                    <img className=' absolute lg:block md:block sm:hidden hidden  lg:top-40 h-40 md:h-40 md:max-w-80 lg:max-w-[100%] lg:h-auto lg:w-[450px] md:left-[370px] lg:left-22' src="/logos/lappy.png" alt="" />
                </div>
                <div className="flex lg:pt-45 pt-30 md:pt-45 sm:pt-30 lg:mt-0 md:mt-10    flex-column">
                    <h1 className='lg:pl-0 md:pl-0 sm:pl-10 pl-12 text-white'>DigitalMna</h1>
                    <p className='text-[#CCD2D9] lg:w-[540px] lg:pl-0 md:pl-0 sm:pl-10 pl-12 mt-4 text-lg w-[90%] sm:w-[80%]  '>Crypto apps are mobile or web applications
