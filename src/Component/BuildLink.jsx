...
export default function BuildLink() {
    return (
        <div className=' w-full h-[60%] sm:relative lg:p-0 md:p-0 sm:p-4  p-4  lg:mb-0 md:mb-0 sm:mb-[-20px] mb-[-110px] bg-[#437B81]'>
            <img className='lg:hidden md:hidden h-40 w-60 ml-40 sm:block  mb-[-80px]' src="/logos/lappy2.png" alt="" />
            <div className=' flex lg:flex-row-reverse sm:flex-col-reverse md:flex-row-reverse  h-[600px] '>
                <div className='lg:p-24 sm:p-10 sm:pl-10  lg:pl-33   relative'>
                    ...
                    <img className=' absolute lg:top-40 h-40 md:h-40 md:max-w-80 lg:max-w-[100%] lg:h-auto lg:w-[450px] md:left-[-550px] lg:left-22' src="/logos/lappy2.png" alt="" />
                </div>
                <div className="flex lg:pt-45 pt-30 md:pt-45 sm:pt-30 lg:mt-0 md:mt-10 flex-column">
                    <h1 className='lg:pl-4 md:pl-32 sm:pl-0 pl-12 text-white'>Buildlink</h1>
